...
namespace movement
{
    public partial class Level04 : Form
    {
        public Level04()
        {
            InitializeComponent();
            ...
            tutorial2.Parent = background;
            tutorial2.BackColor = Color.Transparent;
        ...
        static PictureBox object7_left = new PictureBox();
        static PictureBox object7_right = new PictureBox();
        static PictureBox object7_top = new PictureBox();
        static PictureBox object7_bottom = new PictureBox();

        static bool jump, left, right, airtime, onground, finished, cycle;
        static int speed = 10;
        static int delay = 0;

        private void delaymovingobject_Tick(object sender, EventArgs e)
        {
            delay++;
            if (delay >= 1)
            {
                ...
                delaymovingobject.Stop();
            }
        }

        static int jumpHeight = 130;
        ...
        public void hitboxes()
        {
            ...
            object1_left.Location = new System.Drawing.Point(object1.Location.X, object1.Location.Y + 8);
            object1_left.Size = new System.Drawing.Size(1, object1.Height - 16);
            object1_left.Visible = false;
            object1_left.BackColor = Color.Red;
            this.Controls.Add(object1_left);

            object1_right.Location = new Point(object1.Location.X + object1.Width - 1, object1.Location.Y + 8);
            object1_right.Size = new System.Drawing.Size(1, object1.Height - 16);
            ...
            object3_left.Location = new System.Drawing.Point(object3.Location.X, object3.Location.Y + 8);
            object3_left.Size = new System.Drawing.Size(1, object3.Height - 16);
            object3_left.Visible = false;
            object3_left.BackColor = Color.Red;
            this.Controls.Add(object3_left);

            object3_right.Location = new Point(object3.Location.X + object3.Width - 1, object3.Location.Y + 8);
            object3_right.Size = new System.Drawing.Size(1, object3.Height - 16);
            ...
            object4_left.Location = new System.Drawing.Point(object4.Location.X, object4.Location.Y + 8);
            object4_left.Size = new System.Drawing.Size(1, object4.Height - 16);
            object4_left.Visible = false;
            object4_left.BackColor = Color.Red;
            this.Controls.Add(object4_left);

            object4_right.Location = new Point(object4.Location.X + object4.Width - 1, object4.Location.Y + 8);
            object4_right.Size = new System.Drawing.Size(1, object4.Height - 16);
            ...
            object5_left.Location = new System.Drawing.Point(object5.Location.X, object5.Location.Y + 8);
            object5_left.Size = new System.Drawing.Size(1, object5.Height - 16);
            object5_left.Visible = false;
            object5_left.BackColor = Color.Red;
            this.Controls.Add(object5_left);

            object5_right.Location = new Point(object5.Location.X + object5.Width - 1, object5.Location.Y + 8);
            object5_right.Size = new System.Drawing.Size(1, object5.Height - 16);
            ...
            object6_left.Location = new System.Drawing.Point(object6.Location.X, object6.Location.Y + 8);
            object6_left.Size = new System.Drawing.Size(1, object6.Height - 16);
            object6_left.Visible = false;
            object6_left.BackColor = Color.Red;
            this.Controls.Add(object6_left);

            object6_right.Location = new Point(object6.Location.X + object6.Width - 1, object6.Location.Y + 8);
            object6_right.Size = new System.Drawing.Size(1, object6.Height - 16);
            ...
            object7_left.Location = new System.Drawing.Point(object7.Location.X, object7.Location.Y + 8);
            object7_left.Size = new System.Drawing.Size(1, object7.Height - 16);
            object7_left.Visible = false;
            object7_left.BackColor = Color.Red;
            this.Controls.Add(object7_left);

            object7_right.Location = new Point(object7.Location.X + object7.Width - 1, object7.Location.Y + 8);
            object7_right.Size = new System.Drawing.Size(1, object7.Height - 16);
            object7_right.Visible = false;
            object7_right.BackColor = Color.Red;
            this.Controls.Add(object7_right);

            object7_top.Location = new Point(object7.Location.X, object7.Location.Y);
            object7_top.Size = new System.Drawing.Size(object7.Width, 1);
            object7_top.Visible = false;
            object7_top.BackColor = Color.Red;
            this.Controls.Add(object7_top);

            object7_bottom.Location = new Point(object7.Location.X, object7.Location.Y + object7.Height);
            object7_bottom.Size = new System.Drawing.Size(object7.Width, 1);
            object7_bottom.Visible = false;
            object7_bottom.BackColor = Color.Red;
            this.Controls.Add(object7_bottom);
        }
        private void movementTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (cycle == true)
            {
                if (delaymovingobject.Enabled == false) { object2.Top -= 4; }
                ///-OBJECT2-\\\

                object2_left.Location = new System.Drawing.Point(object2.Location.X, object2.Location.Y + 8);
                object2_left.Size = new System.Drawing.Size(1, object2.Height - 16);
                object2_left.Visible = false;
                object2_left.BackColor = Color.Red;
                this.Controls.Add(object2_left);

                object2_right.Location = new Point(object2.Location.X + object2.Width - 1, object2.Location.Y + 8);
                object2_right.Size = new System.Drawing.Size(1, object2.Height - 16);
                ...
                if (object2.Location.Y <= 134) { delay = 0; delaymovingobject.Start(); }
            }
            if (cycle== false)
            {
                if (delaymovingobject.Enabled == false) { object2.Top += 4; }
                ...
                object2_bottom.BackColor = Color.Red;
                this.Controls.Add(object2_bottom);
                if (object2.Location.Y >= 530) { delay = 0; delaymovingobject.Start(); }
            }
            ...
            //HITBOXES OBJECT 7
            if (player.Bounds.IntersectsWith(object7_left.Bounds))
            {
                player.Location = new Point(object7.Location.X - player.Width, player.Location.Y);
                label1.Text = "left boundaries (object 7)";
            }
            if (player.Bounds.IntersectsWith(object7_right.Bounds))
            {
                player.Location = new Point(object7.Location.X + object7.Width, player.Location.Y);
                label1.Text = "right boundaries (object 7)";
            }
            if (player.Bounds.IntersectsWith(object7_top.Bounds))
            {
                player.Location = new Point(player.Location.X, object7.Location.Y - player.Height + 1);
                label1.Text = "top boundaries (object 7)";
            }
            if (player.Bounds.IntersectsWith(object7_bottom.Bounds))
            {
                player.Location = new Point(player.Location.X, object7.Location.Y + object7.Height);
                label1.Text = "bottom boundaries (object 7)";
                airtime = false;
            }
            ...
            if (player.Bounds.IntersectsWith(object3_top.Bounds) || player.Bounds.IntersectsWith(object7_top.Bounds) || player.Bounds.IntersectsWith(object6_top.Bounds) || player.Bounds.IntersectsWith(object5_top.Bounds) || player.Bounds.IntersectsWith(object4_top.Bounds) || player.Bounds.IntersectsWith(floor.Bounds) || player.Bounds.IntersectsWith(object1_top.Bounds) || player.Bounds.IntersectsWith(object2_top.Bounds)) { onground = true; }
            else { onground = false; }
